#!/bin/bash
# Updated File to do shell processing for conditioning of Input 
# file with 500 RSS values of Rows of alternating rows of Node A and Node B
# to two seperate files (one for each node), with each row of 1000 values
