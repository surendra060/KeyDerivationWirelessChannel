...
Implementation of Measurement and Capturing RSS Array to file using JeeNode v5 Devices
********************************************************************
...
5.	The output of measured RSS values by both TX and RX nodes can be observed using Arduino
IDE serial monitor or can be written to file using the python script.

6. Python Command to store Data to file :-

	python serialDumpRSSI.py <OptionalFilname_Append>
